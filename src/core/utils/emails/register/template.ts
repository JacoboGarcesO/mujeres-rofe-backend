                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 20px;word-break:break-word;">
                        <div
                          style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:20px;text-align:justify;color:#000000; margin-bottom: 20px;">
                          ${data.firstName} ${data.lastName}, bienvenida a <strong>Mujeres ROFÉ</strong>, una comunidad
                          que busca facilitar la autosuficiencia e independencia económica de mujeres cabeza de hogar.
                        </div>
                        <div
                          style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:20px;text-align:justify;color:#000000;">
                          Ahora que te has registrado exitosamente, ya puedes disfrutar de todos los beneficios de la
                          comunidad. Estos son los pasos que debes seguir ahora:
                        </div>
                      </td>
                    </tr>
                    <tr>
                          ...
                          <ol>
                            <li>
                              <div
                                style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:20px;text-align:left;color:#000000;">
                                <div>
                                  Ya tienes acceso a nuestro sitio web:
                                  <a href="https://mujeresrofe.com"
                                    style="display:inline-block;color:#F93548;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;"
                                    target="_blank"> Ir al sitio </a>
                                </div>
                                Estas son tus credenciales de acceso:
                                <ul>
                                  <li>Correo: ${data.email}</li>
                                  <li>Contraseña: ${data.firstName.charAt(0).toUpperCase() +
  data.lastName.charAt(0).toLowerCase() + data.documentNumber}</li>
                                </ul>
                              </div>
                            </li>
                            <li>
                              Cuando ya hayas ingresado al sitio web, en la sección de perfil debes actualizar tu
                              perfil personal, así como también agregar el link de las redes sociales con las que
                              cuentas.
                            </li>
                            <li>
                              Ingresa al grupo de Facebook de Mujeres ROFÉ:
                              <a href="https://www.facebook.com/groups/mujeresrofe"
                                style="display:inline-block;color:#F93548;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;"
                                target="_blank">Grupo</a>
                            </li>
                            <li>
                              Descargar la App de zoom donde veremos las sesiones interactivas.
                            </li>
                          </ol>
