                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 20px;word-break:break-word;">
                        <div
                          ...
                          ${data.firstName} ${data.lastName}, aquí están tus credenciales de acceso para
                      ...
                      <td align="left" style="font-size:0px;padding:10px 20px;word-break:break-word;">
                        <div
                          ...
                          Estas son tus credenciales de acceso: <ul>
                            ...
                            <li>Contraseña: ${data.firstName.charAt(0).toUpperCase() + data.lastName.charAt(0).toLowerCase() + data.documentNumber}</li>
                          </ul>
                        </div>
                      </td>
                    </tr>
