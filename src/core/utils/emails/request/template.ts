                      ...
                      <tbody>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 20px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:20px;text-align:center;color:#000000;">Hola, ${data.firstName} ${data.lastName}, recibimos tu formulario de aplicación, vamos a validar tus datos y prontamente estaremos comunicándonos contigo para indicarte los pasos que debes seguir.</div>
                          </td>
                        </tr>
                        <tr>
